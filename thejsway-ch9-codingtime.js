...
accountArr = [sean, brad, georges];
const sean = new Account('Sean');
const brad = new Account('Brad');
const georges = new Account('Georges');
for(let customers = 0; customers < accountArr.length; customers++){
    accountArr[customers].credit(1000);
    console.log(accountArr[customers].describe());
}
...
// const brad = new Account('Brad');
// const georges = new Account('Georges');
// accountArr.push(sean, brad, georges);
// for(let customers of accountArr){
//     customers.credit(1000);
//     console.log(customers.describe());
// }

// const sean = new Account('Sean');
// const brad = new Account('Brad');
// const georges = new Account('Georges');
// let customers = [sean, brad, georges];
// sean.credit(1000)
// brad.credit(1000)
// georges.credit(1000)
